...
import com.genesis.modelo.facade.FacturaFacade;
...
public class FacturaController implements Serializable {
    ...
    @EJB
    private com.genesis.modelo.facade.FacturaFacade ejbFacade;
    ...
    public Factura getSelected() {
        if (current == null) {
            current = new Factura();
            current.setFacturaPK(new com.genesis.modelo.entities.FacturaPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public String create() {
        try {
            current.getFacturaPK().setIdProducto(current.getProducto().getIdProducto());
            current.getFacturaPK().setIdPedido(current.getPedido().getIdPedido());
    ...
    public Factura getFactura(com.genesis.modelo.entities.FacturaPK id) {
    ...
    public static class FacturaControllerConverter implements Converter {
        ...
        com.genesis.modelo.entities.FacturaPK getKey(String value) {
            com.genesis.modelo.entities.FacturaPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.genesis.modelo.entities.FacturaPK();
            key.setIdProducto(Integer.parseInt(values[0]));
            key.setIdPedido(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(com.genesis.modelo.entities.FacturaPK value) {
